    ...
    <header className="header">
      <div className="header__left">
        <Link href="/" className="header__logo" style={{ textDecoration: 'none' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1 }} suppressHydrationWarning>
            <span style={{ fontWeight: 900, fontSize: '1.4rem', letterSpacing: '-0.03em', color: 'var(--text-primary)' }} suppressHydrationWarning>pixel</span>
            <span style={{ fontWeight: 900, fontSize: '1.4rem', letterSpacing: '-0.03em', color: 'var(--text-primary)' }} suppressHydrationWarning>gamez</span>
          </div>
        </Link>
      </div>
      ...
      <div className="header__right">
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center', marginRight: '8px' }} className="header__socials" suppressHydrationWarning>
          <a href="https://discord.gg/pyAyWAhyqM" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-dim)', transition: 'color 0.2s' }} suppressHydrationWarning>
          ...
          <a href="https://www.youtube.com/@PixelGamezgg" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-dim)', transition: 'color 0.2s' }} suppressHydrationWarning>
          ...
          <a href="https://www.tiktok.com/@pixelgamez.gg" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-dim)', transition: 'color 0.2s' }} suppressHydrationWarning>
          ...
          <a href="https://x.com/PixelGamezgg" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-dim)', transition: 'color 0.2s' }} suppressHydrationWarning>
